...
(20, '活動名稱:光—臺灣文化的啟蒙與自覺 ', '1655175145740.jpg', '1655175145742.jpg', '2022-06-14 00:00:00', '2022-06-26 00:00:00', '2022-06-14 02:51:07', '活動內容活動內容活動內容活動內容活動內容', 8, 1, 7);
...
--
ALTER TABLE `blog_comment`
  MODIFY `blog_comment_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
...
--
ALTER TABLE `exhibition_actadm`
  MODIFY `id` int NOT NULL AUTO_INCREMENT COMMENT '主鍵', AUTO_INCREMENT=21;
...
--
ALTER TABLE `exhibition_ticket`
  MODIFY `tid` int NOT NULL AUTO_INCREMENT COMMENT '主鍵 票券', AUTO_INCREMENT=8;
