...
(5, '賦：袁旃個展', '2022-04-23', '2022-07-24', '1654408323187.jpeg', '2022-07-14', 70, 1, '青年票', 1, '台中美術館'),
(6, '賦：袁旃個展', '2022-04-23', '2022-07-24', '1654408323187.jpeg', '2022-07-14', 70, 2, '青年票', 1, '台中美術館'),
(7, '賦：袁旃個展', '2022-04-23', '2022-07-24', '1654408323187.jpeg', '2022-07-14', 70, 2, '青年票', 1, '台中美術館'),
(8, '賦：袁旃個展', '2022-04-23', '2022-07-24', '1654408323187.jpeg', '2022-07-14', 70, 2, '青年票', 1, '台中美術館'),
(9, '賦：袁旃個展', '2022-04-23', '2022-07-24', '1654408323187.jpeg', '2022-07-14', 70, 3, '青年票', 1, '台中美術館'),
(10, '賦：袁旃個展', '2022-04-23', '2022-07-24', '1654408323187.jpeg', '2022-07-14', 70, 1, '青年票', 1, '台中美術館'),
(11, '賦：袁旃個展', '2022-04-23', '2022-07-24', '1654408323187.jpeg', '2022-06-29', 200, 1, '成人票', 1, '台中美術館'),
(12, '光—臺灣文化的啟蒙與自覺 臺灣文化協會一○○年', '2022-05-21', '2022-09-18', '1654408257615.jpeg', '2022-06-25', 200, 2, '成人票', 1, '高雄美術館'),
(13, '賦：袁旃個展', '2022-04-23', '2022-07-24', '1654408323187.jpeg', '2022-06-09', 70, 1, '青年票', 1, '台中美術館'),
(14, '光—臺灣文化的啟蒙與自覺 臺灣文化協會一○○年', '2022-05-21', '2022-09-18', '1654408257615.jpeg', '2022-06-09', 200, 1, '成人票', 1, '高雄美術館'),
(15, '賦：袁旃個展', '2022-04-23', '2022-07-24', '1654408323187.jpeg', '2022-06-13', 200, 2, '成人票', 1, '台中美術館'),
(16, '光—臺灣文化的啟蒙與自覺 臺灣文化協會一○○年', '2022-05-21', '2022-09-18', '1654408257615.jpeg', '2022-06-15', 50, 2, '兒童票', 1, '高雄美術館'),
(17, '【「什麼是『番』－清帝國文獻裡的臺灣原住民族」特展】', '2022-03-18', '2022-06-18', 'EX010.jpg', '2022-05-24', 200, 1, '成人票', 1, '故宮博物院'),
(18, '【「什麼是『番』－清帝國文獻裡的臺灣原住民族」特展】', '2022-03-18', '2022-06-18', 'EX010.jpg', '2022-05-24', 200, 1, '成人票', 1, '故宮博物院'),
...
(11, '什麼都有商號-澎湖水師的祕密特展', '019.jpg', NULL, '2021-10-09 00:00:00', '2022-06-26 00:00:00', '2022-06-09 04:58:38', '本次特展以複製《什麼都有商號-澎湖水師的祕密》漫畫手稿作品為主，將這部記錄明、清時期澎湖水師官兵的事蹟、碑匾文物、船艦陣法、四大戰役等豐富精采的故事整理為展示主題，分為澎湖水師的開端、澎湖水師的祕密、澎湖水師協的變遷、澎湖的內憂外患、水師與澎湖的記憶等內容，以生動活潑的漫畫導引民眾瞭解這段歷史背景，增進民眾尋訪各階段水師歷程的興趣與意願，具有傳承歷史與文化的重要意義。', 20, 11, 16);
...
(3, '國寶奇種烏龍茶組', 'tea_L2.jpg', 1000, 3, '2022-06-13 17:30:42', 1),
(4, '國寶奇種烏龍茶組', 'tea_L2.jpg', 1000, 1, '2022-06-13 17:59:48', 1);
...
INSERT INTO `product_like` (`fkUserId`, `fkProductId`, `pLikeCreatedTime`) VALUES
(1, 6, '2022-06-09 23:40:51'),
(1, 5, '2022-06-10 00:46:48'),
(1, 4, '2022-06-13 02:05:09');
...
(1, 'joseph', '!Joseph0326', 'artilize.official@gmail.com', 'Joseph', '0912345679', '高雄市前金區中正四路700號', 'Joseph123', '1654485271065.jpg', '1997-03-26', 1, '2022-06-03 14:27:17'),
...
--
ALTER TABLE `exhibition_actadm`
  MODIFY `id` int NOT NULL AUTO_INCREMENT COMMENT '主鍵', AUTO_INCREMENT=20;
...
--
ALTER TABLE `product_main`
  MODIFY `product_id` int NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=22;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `users`
--
ALTER TABLE `users`
  MODIFY `userId` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51227289;
...
--
ALTER TABLE `product_like`
  ADD CONSTRAINT `product_like_ibfk_1` FOREIGN KEY (`fkUserId`) REFERENCES `users` (`userId`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `product_like_ibfk_2` FOREIGN KEY (`fkProductId`) REFERENCES `product_main` (`product_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
