...
import couponBG from "../../images/couponBG.svg";
  ...
  return (
    <>
      ...
      <div className="container ">
        <div className="userPage mx-auto frContent row justify-content-center">
          <h3>我的優惠券</h3>

          <div className="coupon row col-md-12 col-lg-6 justify-content-between my-2">
            <div className="couponImage col-4">
              {/* <img src={couponBG} /> */}
              <FaTicketAlt className="couponIcon mt-2" />
              <h5>{ticketList.exhibition[0]}</h5>
            </div>
            <div className="couponMsg text-center col-8">
