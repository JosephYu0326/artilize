...
function Serach(props) {
  ...
  let searchResult = "現代藝術";
  let searchResultCount = 56;
  ...
  return (
    <>
      ...
      <div className="frContent">
        <div>
          <h5>
            「{searchResult}」搜尋結果　共{searchResultCount}筆
          </h5>
        </div>
        <hr />
        <div>
          <h6>展覽</h6>
          <div className="d-flex searchExhibit">
            <Container>
              <Row className="row searchExhibitCard ">
                <Col className="p-0" md="3" sm="3">
                  <img src="https://picsum.photos/600" alt="exhibitionImage" />
                </Col>
                <Col md="6" sm="12" className="text-start my-2">
                  <div>
          ...
          <div className="text-end">查看更多</div>
        </div>
        <div>
          <h6>商品</h6>
          <Card style={{ width: "16rem" }}>
            ...
            <Card.Body className="text-center">
              ...
              <Button variant="secondary rounded-pill px-3 py-2">
                <h5 className="h5">訂票</h5>
              </Button>
            </Card.Body>
          </Card>
